...
def drop(world, dropQueue, dropSpace):
    ...
    while True:
        ...
        # If wall, stop dropping
        elif getSpace(world, dropSpace) == '#':
            return False
